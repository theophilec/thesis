...
\laboratory{Département d'informatique de l'ENS (DI-ENS, UMR 8548 CNRS-INRIA-ENS) -- équipe SIERRA}
\date{16 octobre 2024}

\pslassetspath{config/psl-cover}

\jurymember{1}{Olivier \textsc{Cappé}}{École Normal Supérieure}{Président}
\jurymember{2}{Gilles \textsc{Blanchard}}{Université Paris Saclay}{Rapporteur} % le président doit être en premier
\jurymember{3}{Eric \textsc{Moulines}}{École Polytechnique}{Rapporteur}
\jurymember{4}{Lorenzo \textsc{Rosasco}}{Università degli Studi di Genova}{Examinateur}
\jurymember{5}{Zoltán \textsc{Szabó}}{London School of Economics}{Examinateur}
\jurymember{6}{Gersende \textsc{Fort}}{Université de Toulouse}{Examinateur}
\jurymember{7}{Benjamin \textsc{Guedj}}{Inria \& University College London}{Directeur de thèse}
\jurymember{8}{Alessandro \textsc{Rudi}}{Inria}{Co-encadrant}
\jurymember{9}{Carlo \textsc{Ciliberto}}{University College London}{Invité, Co-encadrant}

%\jurymember{8}{Alessandro \textsc{Rudi}}{Inria}{Co-encadrant de thèse}
%\jurymember{9}{Carlo \textsc{Ciliberto}}{University College London}{Co-encadrant de thèse}
