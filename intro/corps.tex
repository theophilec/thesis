...
\todo{Add general introduction, presenting the "why". Identify and work with non triviail structure in data. Markopvian structure fuat time series, inmvariations to diffeomorphisms withy two instances.}
