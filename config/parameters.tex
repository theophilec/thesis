...
\usepackage[listformat=empty]{caption} % permet de faire des subfigures (remplace le package subfig)
...
\usepackage[hyperref=true,natbib=true,
			...
			style=authoryear, sorting=nyt]{biblatex}
			%authoryear, numeric ,  alphabetic
